...
| 2:50–3:00 | Close | GitHub URL, MIT, friction log mention | "Open source under MIT, at github.com/harrisjeffery04-stack/provendone. Friction logs from the build are in the repo." |
...
5. Upload public: title "ProvenDone — done AND proven done | Amazon Developer
   Hackathon 2026" · description: one-liner + repo URL
   https://github.com/harrisjeffery04-stack/provendone